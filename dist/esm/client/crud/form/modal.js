...
export function ModalForm({ modalId: thisModalId, mode: thisMode, title, fields, schema, endpoint, parseFetchedData, mutationParams, buttonLabel = false, onSuccess, cols, }) {
