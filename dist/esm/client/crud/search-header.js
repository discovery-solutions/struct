...
export function SearchHeader({ asChild, search, onChange, LeftItems, modalId, hideAdd = false, className }) {
    ...
    return (_jsxs("div", { className: cn("flex flex-row justify-between items-center gap-4", className), children: [_jsxs("div", { className: "flex w-full flex-row items-center gap-4", children: [_jsx(Struct.Input, { placeholder: "Pesquisar...", className: "w-full md:max-w-xs", value: search, onChange: onChange }), LeftItems] }), (hideAdd) ? (null) : asChild ? (_jsx(Struct.Button, { onClick: () => openModal({ modalId }), className: "w-full md:w-fit", children: "Adicionar Novo" })) : (_jsx(Struct.Button, { asChild: true, className: "w-full md:w-fit", children: _jsx(Link, { href: pathname + "/register", children: "Adicionar Novo" }) }))] }));
}
