...
export interface Hooks<T, U extends StructUser = StructUser> {
  ...
  afterCreate?: (ctx: HookContext<T, U> & { created: T }) => Promise<void>;
  beforeUpdate?: (ctx: HookContext<T, U> & { id: string }) => Promise<Partial<T> | void | boolean>;
  afterUpdate?: (ctx: HookContext<T, U> & { updated: T }) => Promise<void>;
  beforeDelete?: (ctx: HookContext<T, U>) => Promise<void>;
  afterDelete?: (ctx: HookContext<T, U>) => Promise<void>;
  beforeGet?: (ctx: HookContext<T, U> & { query: any; id?: string }) => Promise<void>;
